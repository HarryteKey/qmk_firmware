...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  */
  [_BS] = LAYOUT( \
    ...
    KC_ESC,  KC_LWIN, KC_LALT, JP_ZKHK, MO(_LW), KC_SPC,  SHIFT,   MO(_RS), KC_MINS, KC_LEFT, KC_DOWN, KC_RGHT  \
  ),
  ...
  */
  [_GL] = LAYOUT( \
    ...
    _______, KC_I,    KC_UP,   _______, _______, _______, KC_PSCR, KC_LSCR, KC_PAUS, JP_AT,   JP_LBRC, KC_F12,  \
