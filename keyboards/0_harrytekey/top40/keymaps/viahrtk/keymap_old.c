...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_Lw] = LAYOUT( /* Lower
      ...
      * |      |   ~  |   `  |   $  |   #  |   ;  |   '  |   [  |   ]  |   _  |      |      |
      * |------+------+------+------+------+------+------+------+------+------+------+------| */
		_______, KC_SLSH, KC_ASTR, KC_MINS, KC_PLUS, KC_EQL,  KC_BSLS, KC_LCBR, KC_RCBR, KC_AMPR, KC_PIPE, _______,
    _______, KC_PERC, KC_CIRC, KC_QUES, KC_EXLM, KC_COLN, KC_DQUO, KC_LPRN, KC_RPRN, KC_AT,   _______, _______,
    _______, KC_TILD, KC_GRV,  KC_DLR,  KC_HASH, KC_SCLN, KC_QUOT, KC_LBRC, KC_RBRC, KC_UNDS, _______, _______,
		_______, _______, _______,          _______,          _______,          MO(_FN), _______, _______, _______),

    [_Rs] = LAYOUT( /* Raise */
		_______, KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    _______,
		_______, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, KC_MUTE, RGB_MOD,
		_______, KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  KC_VOLD, KC_VOLU, _______, RGB_TOG,
